...
function [Image] = filtered_back_projection(RowNumber_I, ColumnNumber_I, PROJECTIONS, source2det_dist)
...
PROJECTIONS = transpose(PROJECTIONS);
Image = back_projection(RowNumber_I, ColumnNumber_I, PROJECTIONS, source2det_dist);
end
